...
class DinnerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        db.collectionGroup("recipes").whereEqualTo("body", "Dinner").get()
        ...
        binding.lunch.setOnClickListener {
            findNavController().navigate(R.id.action_dinnerFragment_to_lunchFragment)
        }

        binding.breakfast.setOnClickListener {
            findNavController().navigate(R.id.action_dinnerFragment_to_dessertFragment)
        }
        ...
        binding.dinner.setOnClickListener {
            findNavController().navigate(R.id.action_dinnerFragment_to_homeFragment)
        }
