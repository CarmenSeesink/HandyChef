...
class DessertFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter.setOnItemClickListener { item, view ->
            ...
            val action = DessertFragmentDirections.actionDessertFragmentToRecipeDetailFragment(recipeItem.recipeItem.id)
            findNavController().navigate(action)
        }

        db.collectionGroup("recipes").whereEqualTo("body", "Dessert").get()
        ...
        binding.addRecipe.setOnClickListener {
            findNavController().navigate(R.id.action_dessertFragment_to_addRecipeFragment)
        }

        binding.lunch.setOnClickListener {
            findNavController().navigate(R.id.action_dessertFragment_to_lunchFragment)
        }

        binding.breakfast.setOnClickListener {
            findNavController().navigate(R.id.action_dessertFragment_to_breakfastFragment)
        }

        binding.dinner.setOnClickListener {
            findNavController().navigate(R.id.action_dessertFragment_to_dinnerFragment)
        }

        binding.dessert.setOnClickListener {
            findNavController().navigate(R.id.action_dessertFragment_to_homeFragment)
        }
