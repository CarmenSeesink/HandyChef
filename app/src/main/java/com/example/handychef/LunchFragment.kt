...
class LunchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter.setOnItemClickListener { item, view ->
            ...
            val action = LunchFragmentDirections.actionLunchFragmentToRecipeDetailFragment(recipeItem.recipeItem.id)
        ...
        binding.addRecipe.setOnClickListener {
            findNavController().navigate(R.id.action_lunchFragment_to_addRecipeFragment)
        }

        binding.breakfast.setOnClickListener {
            findNavController().navigate(R.id.action_lunchFragment_to_breakfastFragment)
        }

        binding.dinner.setOnClickListener {
            findNavController().navigate(R.id.action_lunchFragment_to_dinnerFragment)
        }

        binding.dessert.setOnClickListener {
            findNavController().navigate(R.id.action_lunchFragment_to_dessertFragment)
        }

        binding.lunch.setOnClickListener {
            findNavController().navigate(R.id.action_lunchFragment_to_homeFragment)
        }
